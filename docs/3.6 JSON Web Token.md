...
Although JWT.io, has a number of third partry libraries which supporting the JWT validation between step 1 and step 3. But a custom validation is still required for checking the NMOS private claims on step 4.

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMzc0NDE2M119
-->