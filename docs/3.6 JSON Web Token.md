...
| nbf | The `nbf` (not before) claim identifies the time on which the JWT will start to be accepted for processing. The value must be a NumericDate. |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU3OTUzNDc2NV19
-->