...
There are three steps to verify the access token. First verify the signature with the issuer Public Key, then  can be veified  To verify the access token, 
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDU0MjY2MTE4XX0=
-->