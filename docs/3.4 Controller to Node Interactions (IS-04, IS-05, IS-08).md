...
Controller t Registryiagesontroetoreistryng
...
Once the Controller has obtained  resource list, it can use the IS-05 Connection API to requestt the sender's SDP and make connections between receivers and senders.

#### SDP Request 
![Controller to Registry](./images/controller_to_nodes.png)

Exampletsender SDP request including Access Token (`Authorization: Bearer`) in the HTTP header:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNDA0MDA0MDQsLTEyNzkwNTc0NDIsLT
IwNTE1MTMxNzAsMTU5NDg1MzUwN119
-->