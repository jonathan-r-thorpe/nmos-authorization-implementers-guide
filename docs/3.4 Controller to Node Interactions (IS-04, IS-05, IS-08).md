...
Once the Controller has obtained the NMOS resource list, it can use the IS-05 Connection API to extract the sender's SDP to make connection between receiver and sender.

![Controller to Registry](./images/controller_to_nodes.png)

Example request to get sender SDP including Access Token (This is the `Authorization Bearer` in the HTTP header):
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE1MDU1OTk3MSwtMjA1MTUxMzE3MCwxNT
k0ODUzNTA3XX0=
-->