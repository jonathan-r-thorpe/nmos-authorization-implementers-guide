...
#### Private Claims
IS-10 has introduced some NMOS related private claims, which are related to the NMOS scopes.  These are configured in the Authorization Server and are  covered in [that section](3.3.%20NMOS%20Private%20Claims.md).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAwMzIzMTA3Ml19
-->