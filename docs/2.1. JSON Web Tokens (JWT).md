...
The IS-10 specification gives details of how NMOS API Clients and Servers should use registered claims. In addition to those listed in the specification, others of interest are given below:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDM1NjkyNjE4LC0yMDQ3NTc2MzQyXX0=
-->