...
#### Private Claims
IS-10 has introduced some NMOS related private claims, which are related to the NMOS scopes.  These are configured in the AuThese are covered in the [next section](3.3.%20Private%20Claims.md).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk5NzUwNTkzMV19
-->