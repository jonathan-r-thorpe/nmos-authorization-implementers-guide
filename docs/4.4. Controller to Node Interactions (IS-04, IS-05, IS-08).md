...
The purpose of using [IS-08](https://specs.amwa.tv/is-08/releases/v1.0.1/docs/1.0._Overview.html) API is mapping between one or more audio “Inputs” and one or more audio “Outputs”.


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMzQxMjM2NzMsMTU4NzQxNDIyM119
-->