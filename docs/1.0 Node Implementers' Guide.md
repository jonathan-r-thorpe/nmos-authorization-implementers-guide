...
This section details the interactions between the NMOS Node and the Authorization Server. These include:
 ...
 - **Refreshing the Bearer Token**: Periodically refresh the Access Token 
-**Fetch Authorization Server Public Keys**: These are used to authenticate Access Tokens in incoming API calls.
...
Unlike the Authorization Code Flow, the Client Credential Flow does not issue a refresh token, an so to 'refresh' the token the Client Credential Flow should be repeated.
...
Once the Node has registered with the Authorization Server, and acquired a Bearer Token, the next step is for it to register with the NMOS Registry using the IS-04 API, by including the Bearer Token in the API call.
 ...
 sagram - JRT to sort]_![Node to Registry Interaction](./images/node_to_registry.png)
...
Example resource registration request:
	...
	"ref_type": "internal"}],
	  ...
	  "href": "https://client.example.org:443/",
		...
		},
		{
			"api": {
				"endpoints": [
					{
						"authorization": true,
						"host": "gbdevwind-8ggx.testsuite.nmos.tv",
						"port": 10000,
						"protocol": "https"
					}
				],
			...
			"caps": {},
			"clocks": [],
			"description": "Sony Windows Registry",
			"hostname": "GBDEVWIND-8GGX.testsuite.nmos.tv",
			"href": "https://gbdevwind-8ggx.testsuite.nmos.tv:10000/",
...
"name": "{621847D4-708F-44EA-8F2C-828190A923BC}",
	...
	"port_id": "0a-00-27-00-00-0f"}
			...
			"label": "Sony Windows Registry",
			"services": [
				{
					"href": "https://gbdevwind-8ggx.testsuite.nmos.tv:10000/x-dns-sd/v1.0",
					"type": "urn:x-dns-sd/v1.0"
				},
				{
					"href": "https://gbdevwind-8ggx.testsuite.nmos.tv:10000/x-dns-sd/v1.1",
...
BhcHBseSwgYXPigKYiLCJzdGFydCI6MTkyNjksImVuZCI6MTky
Njl9LCJOYWxYdWRkc1ZBMDRNWVBQIjp7InRleHQiOiJFdmVudC
AmIFRhbGx5IChJUy0wNykiLCJzdGFydCI6MTk5NTIsImVuZCI6
MTk5NzN9LCJlUGdHREF0OHB2QWRuZW9mIjp7InRleHQiOiIjIy
...
dGlvbiBBUEkpIiwic3RhcnQiOjEyNDA1LCJlbmQiOjEyNDU5fS
...
cnQiOjE0ODg4LCJlbmQiOjE0OTA2fX0sImNvbW1lbnRzIjp7Im
...
U0MTkxMTY4OX19LCJoaXN0b3J5IjpbMTkzOTY3MDg0OSwxNTAy
MTUxMyw3MTc2MDgyNzIsNjExNzUwMTE2LC0xNDU1NzEwODI3LD
E5MTY2MzE4NzUsMjMwMTYxNTg1LDgxNzc0MDE2OCwtNTcyODA5
OTI5LC0xMTY2ODc3MzAzLDIwMDM5ODQ1NTQsMTQ0OTY2NTQyNC
wtOTk5ODMwMzQzLC01ODY3Mjk0NDksMTE0MzY4ODM0OCwtMTA0
NzM3NTE2NywtMTE2OTUyMTQxNiw0NjUzNzE3OTksLTU5ODYzOT
YxOSwxNDYxNDUzNzMwXX0=
-->