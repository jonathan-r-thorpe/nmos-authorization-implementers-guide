...
6. Node fetches Authorization Server public keys in every hour for  validating incoming access token.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNDYxMDYwOTQsLTEwMjc1MDUyNzksMT
