...
6. Node fetches Authorization Server public keys in every hour in event of  validating incoming access token.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMjc1MDUyNzksMTU1NDg3Mzg2NywxMT
