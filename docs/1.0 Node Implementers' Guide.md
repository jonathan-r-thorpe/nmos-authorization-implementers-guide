...
MF: I think the textual steps are:
1) Controller is registered with the authorisation server (does that apply, as I think it counts as a "public client"?) *SL: maybe this bit should be describe in another section Controller to Authentication Server Interactions*
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NTY4MDg4NTMsMTU3Njk5OTI5MiwxNj
