...
In order to interact with the Authentication Server, you need to know where it is.  IS-10 specifies unicast DNS-SD as the method for the 
...
##### Yet another level
1. Node [discovers Authorization Server](https://specs.amwa.tv/is-10/branches/v1.0-dev/docs/3.0._Discovery.html#dns-sd-advertisement) via unicast DNS-SD.
...
BzdGVwcz8p4oCmIiwic3RhcnQiOjEwMzg2LCJlbmQiOjEwNTY2
...
wic3RhcnQiOjExNzQxLCJlbmQiOjExODYwfSwiUkRqTXZ2bnNW
...
I2MiwiZW5kIjoxMTUyOH0sImJjVlJwdnEwclZmNThteU0iOnsi
...
IsInN0YXJ0IjoxMjk2MSwiZW5kIjoxMjk4Mn0sImVQZ0dEQXQ4
...
YXRlZCI6MTYxMjUxODEyNTAwMH19LCJoaXN0b3J5IjpbNDYxOT
AyNzg5LDExNDM2ODgzNDgsLTEwNDczNzUxNjcsLTExNjk1MjE0
