...
Example query (IS-04) request including Access Token (This is the `Authorization Bearer` in the HTTP header):
	...
	GET /x-nmos/query/nodes HTTP/1.1
    Host: registry.example.org
    Authorization: Bearer eyJhbGciOiJSUzUxMiIsInR5cCIgOiAiSl...
...
BhcHBseSwgYXPigKYiLCJzdGFydCI6MTgwNDksImVuZCI6MTgw
NDl9LCJOYWxYdWRkc1ZBMDRNWVBQIjp7InRleHQiOiJFdmVudC
AmIFRhbGx5IChJUy0wNykiLCJzdGFydCI6MTg3MzIsImVuZCI6
MTg3NTN9LCJlUGdHREF0OHB2QWRuZW9mIjp7InRleHQiOiIjIy
...
cnQiOjE0OTcxLCJlbmQiOjE0OTg5fX0sImNvbW1lbnRzIjp7Im
...
U0MTkxMTY4OX19LCJoaXN0b3J5IjpbLTU0NjA2MjksLTExNzQx
NjU0NDIsNzE3NjA4MjcyLDYxMTc1MDExNiwtMTQ1NTcxMDgyNy
