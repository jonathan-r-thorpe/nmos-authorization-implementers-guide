...
Node attempts to refresh a bearer token at least 15 seconds before token expiry (i.e the half-life of the token).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODc0MDE4OTUwLC0xNDcwMzMwMDc0LDIxMT
