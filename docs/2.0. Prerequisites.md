...
If your NMOS Node implements the IS-07 API then it is assumed you are familiar with the standard and have a working implementation. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNjkyNTg3NjksMjUyMzk3NDk0LDE3ND
