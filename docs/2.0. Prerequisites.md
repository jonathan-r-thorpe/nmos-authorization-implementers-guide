...
If your NMOS Node has audio capability and implements IS-08 then it is assumed that you are familiar with the standard and have a working implementation of IS-08 for your NMOS Node.
...
It's the reason you're here! This guide will detail implementation of IS-10 in NMOS nodes and Controllers for IS-04, IS-05, IS-07 and IS-08 API calls, so a familiarity with the standard is assumed.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMyMTYwODUwMywyNTIzOTc0OTQsMTc0ND
A1OTA5MiwtMjUzNzkzNjkwLDE5ODk3OTEwN119
-->