...
## JSON Web Tokens (JWT)
JSON Web Tokens are the preferred type of token used in IS-10.  A familiarity with JWT can be gained from the articles linked in the OAuth 2.0 section, or from this [introduction to JWT](https://jwt.io/introduction). More details on JWT are given in the next section.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAzODg2NDE4MywtOTg2MjE2MzE3LDQxOD
