...
Signature is created by encoding the Header and Payload using Base64url encoding, then run through the cryptographic algo

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYzNTAwMjA3MCwtODk2NTc0NTczXX0=
-->