...
[
  {
    "api": {
      ...
      "versions": [
        "_comment_": "versions data here"
      ]
    },
    "caps": {
      "_comment_": "caps data here"
    },
    "clocks": [
      "_comment_": "clocks data here"
    ],
    "description": "...",
    ...
    "id": "...",
    "interfaces": [
      "_comment_": "interfaces data here"
    ],
    "label": "My Example Node",
    "services": [
      "_comment_": "services data here"
    ],
    "tags": {
...
```json
{
  ...
  "transport_params": [
    "_comment_": "transport_params data here"
  ]
}
```
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYzODE0MTY4Nl19
-->